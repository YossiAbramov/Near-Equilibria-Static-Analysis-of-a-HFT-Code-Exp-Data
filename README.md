# Description
Supplementary information for Yossi Abramov's research thesis that was done under the supervision of Associate Professor Amir D. Gat. It contains the code used to derive the equations and includes the experimental data along with the code to generate the figures that compare experiments to theory. For more information, refer to the research thesis.
# Contributors
- [Yossi Abramov](https://orcid.org/0009-0009-3157-326X) performed the theoretical work, conducted measurements for the model, compared the theory to experiments, and wrote the research thesis along with the Mathematica file that contains the code and experimental data.
